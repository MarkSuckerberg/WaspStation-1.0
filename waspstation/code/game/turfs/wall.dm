...
/turf/closed/wall
	icon_state = "solid"
	icon = 'waspstation/icons/turf/wall_masks.dmi'
	color = "#787878"
...
/turf/closed/wall/update_icon()
	...
	var/image/I = null
	if(!wall_connections[1] && !wall_connections[3]) //mmmmm hardcoding :drooling:
		var/image/smooth_top_overlay = image(icon, "[initial(icon_state)]_edge", ABOVE_ALL_MOB_LAYER)
