...
/obj/effect/turf_decal/ComponentInitialize()
	...
	T.AddElement(/datum/element/decal, icon, icon_state, turn(dir, -dir2angle(T.dir)), CLEAN_GOD, color, null, null, alpha, appearance_flags)
	if(detail_overlay)
		T.AddElement(/datum/element/decal, icon, detail_overlay, turn(dir, -dir2angle(T.dir)), CLEAN_GOD, detail_color, null, null, alpha, appearance_flags)
