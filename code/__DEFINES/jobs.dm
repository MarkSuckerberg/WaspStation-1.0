...
#define LT				(1<<14) //WASPSTATION EDIT - LIEUTENANT
#define PRISONER		(1<<15)
#define EXPLORER		(1<<16) //WASPSTATION EDIT - EXPLORER
...
#define JOB_DISPLAY_ORDER_LIEUTENANT 4 // WaspStation Begin - Lieutenant
...
#define JOB_DISPLAY_ORDER_BRIG_PHYS 35 //WaspStation Edit - Brig Physicians
