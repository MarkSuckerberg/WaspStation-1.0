	...
	if(wear_mask)
		if(!(ITEM_SLOT_MASK in check_obscured_slots()))
			...
			if(wear_mask.icon_override)
				standing = wear_mask.build_worn_icon(default_layer = FACEMASK_LAYER, default_icon_file = wear_mask.icon_override)
			else if(wear_mask.sprite_sheets && wear_mask.sprite_sheets[dna.species.name])
				standing = wear_mask.build_worn_icon(default_layer = FACEMASK_LAYER, default_icon_file = wear_mask.sprite_sheets[dna.species.name])
			else
				standing = wear_mask.build_worn_icon(default_layer = FACEMASK_LAYER, default_icon_file = 'icons/mob/clothing/mask.dmi')
	...
	if(wear_neck)
		if(!(ITEM_SLOT_NECK in check_obscured_slots()))
			...
			if(wear_neck.icon_override)
				standing = wear_neck.build_worn_icon(default_layer = NECK_LAYER, default_icon_file = wear_neck.icon_override)
			else if(wear_neck.sprite_sheets && wear_neck.sprite_sheets[dna.species.name])
				standing = wear_neck.build_worn_icon(default_layer = NECK_LAYER, default_icon_file = wear_neck.sprite_sheets[dna.species.name])
			else
				standing = wear_neck.build_worn_icon(default_layer = NECK_LAYER, default_icon_file = 'icons/mob/clothing/neck.dmi')
...
/mob/living/carbon/update_inv_back()
	...
	if(back)
		...
		if(back.icon_override)
			...
			standing = back.build_worn_icon(state = back.icon_state, default_layer = BACK_LAYER, default_icon_file = 'icons/mob/clothing/back.dmi')
...
/mob/living/carbon/update_inv_head()
	...
	if(head)
		...
		if(head.icon_override)
			standing = head.build_worn_icon(default_layer = HEAD_LAYER, default_icon_file = head.icon_override)
		else if(head.sprite_sheets && head.sprite_sheets[dna.species.name])
			standing = head.build_worn_icon(default_layer = HEAD_LAYER, default_icon_file = head.sprite_sheets[dna.species.name])
		else
			standing = head.build_worn_icon(default_layer = HEAD_LAYER, default_icon_file = 'icons/mob/clothing/head.dmi')
